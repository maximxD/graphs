...
def main():
    ...
    vertices_list = [100, 500, 1000, 2000, 3000, 5000, 7500,10000, 12500, 15000, 17500, 20000, 25000, 30000, 35000, 40000, 50000, 60000, 70000]
    ...
    for idx, edge_prob in enumerate(edge_probs):
        ...
        for vertices in vertices_list:
            if vertices <= limits[edge_prob][0]:
                times = run_benchmark(vertices, edge_prob)
            elif vertices <= limits[edge_prob][1]:
                times = run_benchmark(vertices, edge_prob, ["--dpc", "--openmp"])
            else:
                continue
        ...
        _vertices_list = [v for v in vertices_list if v <= limits[edge_prob][1]]
